...
class ProjectModule(configuration: CodegenConfiguration) : CodegenModule(configuration) {
    ...
    override fun provideExtensions(generator: Generator) {
        generator.registerExtension(ProjectJavaDependenciesExtension(configuration))
    }
